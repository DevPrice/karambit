...
import {
    ...
    isJSDocTag,
} from "./TypescriptUtil.js"
import {isProvidesProperty} from "./Providers.js"
    ...
    validateAnnotations(node: ts.Node): void {
        ...
        providesAnnotations.forEach(annotation => {
            ...
            if (ts.isMethodDeclaration(parent) || ts.isMethodSignature(parent)) {
                ...
                this.errorReporter.assertValidType(this.typeChecker.getReturnTypeOfSignature(signatures[0]), parent)
            } else {
